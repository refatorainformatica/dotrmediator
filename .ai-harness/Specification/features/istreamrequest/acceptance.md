# Acceptance Criteria — istreamrequest

> Nenhum teste unitário mapeado para `src/istreamrequest` em 2026-08-24.
...
|----|--------------|-----------|
| AC-G01 | PR adiciona `src/istreamrequest` tests | pending |

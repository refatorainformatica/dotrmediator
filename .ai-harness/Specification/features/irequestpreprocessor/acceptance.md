# Acceptance Criteria — irequestpreprocessor

> Nenhum teste unitário mapeado para `src/irequestpreprocessor` em 2026-08-24.
...
|----|--------------|-----------|
| AC-G01 | PR adiciona `src/irequestpreprocessor` tests | pending |

# Acceptance Criteria — dotrmediator-bin

> Nenhum teste unitário mapeado para `src/DotRMediator/bin` em 2026-08-24.
...
|----|--------------|-----------|
| AC-G01 | PR adiciona `src/DotRMediator/bin` tests | pending |

# Acceptance Criteria — dotrmediator-obj

> Nenhum teste unitário mapeado para `src/DotRMediator/obj` em 2026-08-24.
...
|----|--------------|-----------|
| AC-G01 | PR adiciona `src/DotRMediator/obj` tests | pending |

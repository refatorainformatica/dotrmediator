# Acceptance Criteria — inotificationhandler

> Nenhum teste unitário mapeado para `src/inotificationhandler` em 2026-08-24.
...
|----|--------------|-----------|
| AC-G01 | PR adiciona `src/inotificationhandler` tests | pending |
